...
// Cabecera de página
    function Header()
    {
        ...
        $this->Ln(4);
            ...
            $this->Cell(80);
            // Título
            $this->Cell(100, 10, 'Lista de raya semanal', 0, 1, 'C');
            $this->Cell(80);
            $this->Cell(100, 10, "Del: " .$fecha1enc . " al: " . $fecha2enc, 0, 1, 'C');
              $this->SetFont('Arial', 'B', 11);
              $this->Cell(40);
            $this->Cell(100, 10,"     SOMBREROS ACCESORIOS Y PUBLICITARIOS DEL SURESTE SA DE CV", 0, 1, 'C');
            $this->Cell(50);
            $this->Cell(100, 10, "Centro de trabajo: Moctezuma # 307, Col Nuevo México, San Jacinto, Oax.", 0, 1, 'C');

            $this->SetFont('Arial', 'B', 8);
           $this->MultiCell(0,5, "Recibí de conformidad el salario determinado a destajo o salario ordinario por la semana correspondiente, así como, manifiesto mi conformidad de los días laborados y en su caso en los que hubiera ausentismo, esto último sin responsabilidad para la empresa.",0,'J',false);
...
//Aqui indicamos que usará el header normal
$pdf->header = 1;
$pdf->AddPage();
