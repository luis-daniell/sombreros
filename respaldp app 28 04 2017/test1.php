...
//$number_of_products = sqlite_num_rows($result);
...
while($row = sqlite_fetch_array($result))
{
    ...
    $name = substr($row["apellidoempleado"],0,20);
    $real_price = $row["obsempleado"];
    $price_to_show = number_format($row["empleadoactivo"],',','.','.');
